...
GRANT ALL ON TABLE cb_language TO customerdb;
...
GRANT ALL ON TABLE cb_currency TO customerdb;
...
GRANT ALL ON TABLE cb_country TO customerdb;
...
GRANT ALL ON TABLE cb_addresses TO customerdb;
...
GRANT ALL ON TABLE cb_address TO customerdb;
...
ENGINE=InnoDB
COMMENT='';
GRANT ALL ON TABLE cb_paymentmethod TO customerdb;
...
GRANT ALL ON TABLE cb_enterprise TO customerdb;
...
GRANT ALL ON TABLE cb_customer TO customerdb;
